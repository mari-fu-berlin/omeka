...
return $formalVocabularies = array(
    ...
    array(
        'name' => 'MARI',
        'description' => 'Item relations for the MARI project: http://mari-vocab.html',
        'namespace_prefix' => 'mari',
        'namespace_uri' => 'http://purl.org/vocab/frbr/core#',
        'properties' => array(
            array(
                'local_part' => 'linkSupposed',
                'label' => 'Identität angenommen',
                'description' => 'Identität kann als wissenschaftlich gesichert gelten.'
            ),
            array(
                'local_part' => 'linkPossible',
                'label' => 'Identität möglich',
                'description' => 'Identität könnte gegeben sein.'
            ),
          )
    ),
);
