<div id="item-relations-display-item-relations">
    ...
    <?php else: ?>
    <table>
        <?php foreach ($subjectRelations as $subjectRelation): if($subjectRelation['state'] === 'current'): ?>
        <tr>
        ...
        <?php foreach ($objectRelations as $objectRelation): if($objectRelation['state'] === 'current'): ?>
        <tr>
