...
jQuery(window).load(function () {
    ...
    var queryString = jQuery.Gina.parseQueryString();
    if (jQuery.Gina.arrayKeyExists('type', queryString) && window.location.href.indexOf('items/add?type=') !== -1) {
        jQuery('#item-type').val(queryString.type).trigger('change');
    }
